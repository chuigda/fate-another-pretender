...
<template>
    <select v-model="servantClass">
        <option v-if="optional" :value="undefined">-- 无 --</option>
        <option v-for="clazz in ServantClasses" :value="clazz">
            {{ ServantClassDescription[clazz].label }}
        </option>
    </select>
</template>
